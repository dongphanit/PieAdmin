    ...
    return Drawer(
      child: ListView(
        children: [
          ...
          Consumer<MenuControllerA>(
            builder: (context, MenuControllerA, child) =>
                DrawerListTile(listOfModel: MenuControllerA.menuModelList),
          )
        ],
      ),
    );
      ...
      _list_of_listTile.add(InkWell(
        ...
        child: Container(
          ...
          child: ListTile(
            ...
            onTap: () async {
              if (i != 3) {
                // if (context.read<MenuControllerA>().isInMainScreen == false) {
                //   context.read<MenuControllerA>()..onChangeSelectedMenu(i);
                ...
                context.read<AuthController>()
                  ..SignOut().then((value) {
                    context.read<MenuControllerA>()..buildMenu();
                  });
              }
              // if (i == 0) {
